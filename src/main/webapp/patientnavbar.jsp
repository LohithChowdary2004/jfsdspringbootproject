...
<div class="navbar">
    <a href="patienthome" class="active">Home</a>
    <a href="updatepatient">View Profile</a>
    <a href="viewalldoctorsp">Doctors</a>
    <a href="myappointments">My Appointments</a>
    <a href="bookAppointment">Book Appointments</a>
    <a href="viewPatientAppointments">Prescription</a>
