...
<div class="navbar">
    <a href="doctorhome" class="active">Home</a>
    <a href="viewallpatients">View Patients</a>
    <a href="viewappointments">Show Appointments</a>
    <a href="updatedoctor">My Profile</a>
